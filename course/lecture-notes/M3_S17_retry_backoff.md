...
> 대상: `internal/packages/event-engine/src/webhook/RetryHandler.ts`  
>       `internal/packages/event-engine/src/webhook/IdempotencyGuard.ts`  
>       `internal/packages/vasp/src/recovery/VaspRecoveryService.ts`
