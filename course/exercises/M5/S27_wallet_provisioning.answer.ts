...
// ────────────────────────────────────────────────────────────────────────
// 실습 1: UnsupportedVaspError 에러 클래스
// ────────────────────────────────────────────────────────────────────────
...
// ────────────────────────────────────────────────────────────────────────
// 실습 2: WalletProvisioningService
//
...
//
// 획득 후 → WalletMappingService.saveMapping() 으로 DB 저장
// 이후 발행 요청마다 → getWalletAddr()만 사용 (VASP 재호출 없음)
// ────────────────────────────────────────────────────────────────────────
