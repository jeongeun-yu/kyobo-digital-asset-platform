...
// ────────────────────────────────────────────────────────────────────────
// 실습 2: Integer Overflow 보호 시뮬레이션
// ────────────────────────────────────────────────────────────────────────
...
/** unchecked 블록 동작: overflow 시 wrap-around */
...
/** unchecked 블록 사용 시 직접 검증이 필요한 패턴 */
...
// ────────────────────────────────────────────────────────────────────────
// 실습 3: ReentrancyGuard 뮤텍스 시뮬레이션
// ────────────────────────────────────────────────────────────────────────
...
export class ReentrancyGuardSimulator {
  ...
  /** CEI + nonReentrant 이중 방어 적용된 burn */
  burn(balances: Map<string, number>, from: string, amount: number): void {
    this.withNonReentrant(() => {
      ...
      // Interactions 나중에 (재진입 시도 시 _status === ENTERED → revert)
    });
  }

  /**
   * 공격자 컨트랙트가 burn 실행 중 재진입을 시도하는 패턴 시뮬레이션.
   */
...
// ────────────────────────────────────────────────────────────────────────
// 실습 4: Slither False Positive 판별 패턴
// ────────────────────────────────────────────────────────────────────────
