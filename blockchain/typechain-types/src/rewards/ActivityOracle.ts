...
export interface ActivityOracleInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "ORACLE_ROLE"
...
export interface ActivityOracle extends BaseContract {
  connect(runner?: ContractRunner | null): ActivityOracle;
  waitForDeployment(): Promise<this>;

  interface: ActivityOracleInterface;
