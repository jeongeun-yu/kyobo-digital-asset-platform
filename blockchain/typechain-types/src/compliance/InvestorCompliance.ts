...
export interface InvestorComplianceInterface extends Interface {
  getFunction(
    nameOrSignature:
  ...
  encodeFunctionData(
    functionFragment: "COMPLIANCE_ADMIN_ROLE",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setActivePartition",
    values: [BytesLike]
  ): string;
  encodeFunctionData(
...
export interface InvestorCompliance extends BaseContract {
  connect(runner?: ContractRunner | null): InvestorCompliance;
  waitForDeployment(): Promise<this>;

  interface: InvestorComplianceInterface;
  ...
  COMPLIANCE_ADMIN_ROLE: TypedContractMethod<[], [string], "view">;
  ...
  setActivePartition: TypedContractMethod<
    [partition: BytesLike],
    [void],
    "nonpayable"
  >;
  ...
  transferred: TypedContractMethod<
    [arg0: AddressLike, to: AddressLike, amount: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "COMPLIANCE_ADMIN_ROLE"
  ...
  >;
  getFunction(
    nameOrSignature: "setActivePartition"
