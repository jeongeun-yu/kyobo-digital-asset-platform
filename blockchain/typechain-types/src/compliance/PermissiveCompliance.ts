...
export interface PermissiveComplianceInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface PermissiveCompliance extends BaseContract {
  connect(runner?: ContractRunner | null): PermissiveCompliance;
  waitForDeployment(): Promise<this>;

  interface: PermissiveComplianceInterface;
