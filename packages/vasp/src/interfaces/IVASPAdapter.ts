 ...
 *
 * Phase 1: ExternalVASPAdapter (외부 인가 VASP 연동)
 * Phase 4: KyoboVASPAdapter (교보 자체 VASP 인가 취득 후 내재화)
 *
 ...
 *   - Phase 4: 교보생명이 VASP 인가 취득 → 이 인터페이스 내재화
 */
